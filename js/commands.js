...
function help() {
    if(global == 'en-US'){
		...
		printLine('Diese Website ist in den folgenden Sprachen verfügbar: <a class="yellow" onclick="changeLanguageWalkthrough(1)">Englisch</a> und <a class="yellow" onclick="changeLanguageWalkthrough(2)">Deutsch</a>.');
